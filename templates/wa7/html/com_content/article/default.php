...
<div class="com-content-article item-page<?php echo $this->pageclass_sfx; ?>" itemscope itemtype="https://schema.org/Article">
	...
	<dl class="article-info text-muted">
		...
		<?php if (  $params->get('show_parent_category') && $title != "ROOT") : ?>
		<dd class="parent-category-name">
			<?php if ($this->item->params->get('link_parent_category') && !empty($this->item->parent_id)) : ?>
				<?php $url = '<a href="' . Route::_(
					RouteHelper::getCategoryRoute($this->item->parent_id, $this->item->parent_language)
					)
