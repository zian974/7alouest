 ...
 * @since  0.0.5
 */
class StageModel extends ItemModel
{
	public $_item;
	...
	protected function populateState()
	{
		...
		{
			$id = Factory::getApplication()->getUserState('com_stages.agenda.edit.id');
		}
		else
		{
			$id = Factory::getApplication()->input->get('id');
			Factory::getApplication()->setUserState('com_stages.agenda.edit.id', $id);
		}
		$this->setState('stage.id', $id);
		...
		{
			$this->setState('stage.id', $params_array['item_id']);
		}
	...
	public function getItemIdByAlias($alias)
	{
		...
		{
			$aliasKey   = $this->getAliasFieldNameByView('stage');
		}
	...
	{
		// Get the id.
		$id = (!empty($id)) ? $id : (int) $this->getState('stage.id');
